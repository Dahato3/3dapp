            ...
            $("select option:selected").each(function () {              
                ...
                .done(function(json) {
                  ...
                  for (var i=0; i<json.length; i++) {
                      ...
                      str+= 
                        "<div width='15%' style='float:left; color:black; margin:5px;border:1px solid; border-color: red; padding:10px;'>" + json[i].brand + "</div>" + 
                        "<div width='15%' style='float:left; color:black; margin:5px;border:1px solid; border-color: red; padding:10px;'>" + json[i].x3dModelTitle + "</div>" + 
                        "<div width='15%' style='float:left; color:black; margin:5px;border:1px solid; border-color: red; padding:10px;'>" + json[i].x3dCreationMethod + "</div> <br> <br> <br>" +
                        "<div width='15%' style='float:left; color:black; margin:5px;border:1px solid; border-color: red; padding:10px;'>" + json[i].modelTitle + "</div>" +
                        "<div width='15%' style='float:left; color:black; margin:5px;border:1px solid; border-color: red; padding:10px;'>" + json[i].modelDescription + "</div>";
                      ...
                      str +=
                        ...
                        "<img width='300px' src = '../gallery/db_images/" + json[i].brand + ".png'></img>" +
                        "</div>";
                  }
